 ...
 */ const evaluateCalcToLengthPercentage = function(calcToken) {
    let contextValue = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
 ...
 */ const parsePosition = (tokens)=>{
    ...
    return {
        cx: cx !== null && cx !== void 0 ? cx : FIFTY_PERCENT,
        cy: cy !== null && cy !== void 0 ? cy : FIFTY_PERCENT
    };
};
/**
 ...
 */ const parseInset = (values)=>{
    ...
    for (const token of values){
        if (token.type === 31 /* TokenType.WHITESPACE_TOKEN */ ) continue;
        if (isIdentToken(token) && token.value === 'round') break;
        if (isLengthPercentage(token)) lengths.push(token);
    }
    var _lengths_;
    const v0 = (_lengths_ = lengths[0]) !== null && _lengths_ !== void 0 ? _lengths_ : ZERO_LENGTH;
    var _lengths_1;
    const v1 = (_lengths_1 = lengths[1]) !== null && _lengths_1 !== void 0 ? _lengths_1 : v0;
    var _lengths_2;
    const v2 = (_lengths_2 = lengths[2]) !== null && _lengths_2 !== void 0 ? _lengths_2 : v0;
    var _lengths_3;
    const v3 = (_lengths_3 = lengths[3]) !== null && _lengths_3 !== void 0 ? _lengths_3 : v1;
    return {
        type: 1 /* CLIP_PATH_TYPE.INSET */ ,
        top: v0,
        right: v1,
        bottom: v2,
        left: v3
...
class CSSParsedDeclaration {
    ...
    constructor(context, declaration){
        ...
        var _declaration_textDecorationColor;
        this.textDecorationColor = parse(context, textDecorationColor, (_declaration_textDecorationColor = declaration.textDecorationColor) !== null && _declaration_textDecorationColor !== void 0 ? _declaration_textDecorationColor : declaration.color);
        var _declaration_textDecorationLine;
        this.textDecorationLine = parse(context, textDecorationLine, (_declaration_textDecorationLine = declaration.textDecorationLine) !== null && _declaration_textDecorationLine !== void 0 ? _declaration_textDecorationLine : declaration.textDecoration);
...
const createCounterStyleFromSymbols = function(value, symbols) {
...
class DocumentCloner {
    toIFrame(ownerDocument, windowSize) {
         ...
         */ const iframeLoad = iframeLoader(iframe).then(async ()=>{
            ...
            if (typeof referenceElement === 'undefined') {
                throw new Error("Error finding the ".concat(this.referenceElement.nodeName, " in the cloned document"));
            }
        ...
        try {
            var _this_referenceElement_ownerDocument, _trustedTypesFactory_getPolicy;
            ...
            const ownerWindow = (_this_referenceElement_ownerDocument = this.referenceElement.ownerDocument) === null || _this_referenceElement_ownerDocument === void 0 ? void 0 : _this_referenceElement_ownerDocument.defaultView;
            const trustedTypesFactory = ownerWindow && ownerWindow.trustedTypes;
            let policy = trustedTypesFactory === null || trustedTypesFactory === void 0 ? void 0 : (_trustedTypesFactory_getPolicy = trustedTypesFactory.getPolicy) === null || _trustedTypesFactory_getPolicy === void 0 ? void 0 : _trustedTypesFactory_getPolicy.call(trustedTypesFactory, 'html2canvas-pro');
        ...
        try {
            ...
            if (clonedCtx) {
                if (!this.options.allowTaint && ctx) {
                    ...
                    const gl = (_canvas_getContext = canvas.getContext('webgl2')) !== null && _canvas_getContext !== void 0 ? _canvas_getContext : canvas.getContext('webgl');
                    if (gl) {
    ...
    resolvePseudoContent(node, clone, style, pseudoElt) {
        ...
        const newClassName = pseudoElt === PseudoElementType.BEFORE ? " ".concat(PSEUDO_HIDE_ELEMENT_CLASS_BEFORE) : " ".concat(PSEUDO_HIDE_ELEMENT_CLASS_AFTER);
...
const restoreNodeScroll = (param)=>{
    let [element, x, y] = param;
...
const createPseudoHideStyles = (body, cspNonce)=>{
    createStyles(body, ".".concat(PSEUDO_HIDE_ELEMENT_CLASS_BEFORE).concat(PSEUDO_BEFORE).concat(PSEUDO_HIDE_ELEMENT_STYLE, "\n         .").concat(PSEUDO_HIDE_ELEMENT_CLASS_AFTER).concat(PSEUDO_AFTER).concat(PSEUDO_HIDE_ELEMENT_STYLE), cspNonce);
};
...
const addBase = (targetELement, baseUri)=>{
    ...
    var _headEle_firstChild;
    headEle === null || headEle === void 0 ? void 0 : headEle.insertBefore(baseNode, (_headEle_firstChild = headEle === null || headEle === void 0 ? void 0 : headEle.firstChild) !== null && _headEle_firstChild !== void 0 ? _headEle_firstChild : null);
};
class Vector {
    add(deltaX, deltaY) {
        ...
        case 4 /* CLIP_PATH_TYPE.POLYGON */ :
            {
                ...
                const absPoints = clipPath.points.map((param)=>{
                    let [px, py] = param;
                    return [
                        bLeft + getAbsoluteValue(px, bWidth),
                        bTop + getAbsoluteValue(py, bHeight)
                    ];
                });
                return new ClipPathEffect((ctx)=>{
                    ctx.beginPath();
...
const calculateBackgroundSize = (size, param, bounds)=>{
    let [intrinsicWidth, intrinsicHeight, intrinsicProportion] = param;
...
const calculateBackgroundRepeatPath = (repeat, param, param1, backgroundPositioningArea, backgroundPaintingArea)=>{
    let [x, y] = param, [width, height] = param1;
    switch(repeat){
 ...
 */ class BackgroundRenderer {
     ...
     */ renderLinearGradient(container, backgroundImage, index) {
        ...
        var _this_canvas_ownerDocument;
        const ownerDocument = (_this_canvas_ownerDocument = this.canvas.ownerDocument) !== null && _this_canvas_ownerDocument !== void 0 ? _this_canvas_ownerDocument : document;
...
const fixIOSSystemFonts = (fontFamilies)=>{
    ...
    if (iosVersion !== null && iosVersion >= 15 && iosVersion < 17) {
        return fontFamilies.map((fontFamily)=>iOSBrokenFonts.indexOf(fontFamily) !== -1 ? '-apple-system, "Helvetica Neue", Arial, sans-serif' : fontFamily);
    }
    return fontFamilies;
};
/**
 ...
 */ class TextRenderer {
     ...
     */ createFontStyle(styles) {
        ...
        const fontSize = isDimensionToken(styles.fontSize) ? "".concat(styles.fontSize.number).concat(styles.fontSize.unit) : "".concat(styles.fontSize.number, "px");
        return [
            [
                styles.fontStyle,
                fontVariant,
...
class CanvasRenderer extends Renderer {
        ...
        if (container instanceof ImageElementContainer) {
            try {
                ...
                if (styles.imageRendering === IMAGE_RENDERING.PIXELATED || styles.imageRendering === IMAGE_RENDERING.CRISP_EDGES) {
                    this.context.logger.debug("Disabling image smoothing for ".concat(container.src, " due to CSS image-rendering: ").concat(styles.imageRendering === IMAGE_RENDERING.PIXELATED ? 'pixelated' : 'crisp-edges'));
                    this.ctx.imageSmoothingEnabled = false;
                } else if (styles.imageRendering === IMAGE_RENDERING.SMOOTH) {
                    this.context.logger.debug("Enabling image smoothing for ".concat(container.src, " due to CSS image-rendering: smooth"));
    ...
    constructor(context, options){
        ...
        this.context.logger.debug("Canvas renderer initialized (".concat(options.width, "x").concat(options.height, ") with scale ").concat(options.scale));
    }
}
...
class ForeignObjectRenderer extends Renderer {
    ...
    constructor(context, options){
        ...
        this.ctx.scale(this.options.scale, this.options.scale);
        this.ctx.translate(-options.x, -options.y);
        this.context.logger.debug("EXPERIMENTAL ForeignObject renderer initialized (".concat(options.width, "x").concat(options.height, " at ").concat(options.x, ",").concat(options.y, ") with scale ").concat(options.scale));
    }
}
    ...
    warn() {
        ...
        if (this.enabled) {
            if (typeof window !== 'undefined' && window.console && typeof console.warn === 'function') {
                console.warn(this.id, "".concat(this.getTime(), "ms"), ...args);
            } else {
                this.info(...args);
            }
        }
...
class Cache {
    ...
    async _addImageInternal(src) {
        var _this__options_imageTimeout;
        // Create image load promise with timeout protection
        const timeoutMs = (_this__options_imageTimeout = this._options.imageTimeout) !== null && _this__options_imageTimeout !== void 0 ? _this__options_imageTimeout : 15000;
        const timeoutPromise = new Promise((_, reject)=>{
            setTimeout(()=>{
                reject(new Error("Image load timeout after ".concat(timeoutMs, "ms: ").concat(src)));
            }, timeoutMs);
        });
        // Race between image load and timeout
        const imageWithTimeout = Promise.race([
            this.loadImage(src),
            timeoutPromise
        ]);
        // Handle errors to prevent unhandled rejections
        imageWithTimeout.catch((error)=>{
            this.context.logger.error("Failed to load image ".concat(src, ": ").concat(error instanceof Error ? error.message : 'Unknown error'));
        });
     ...
     */ evictLRU() {
        ...
        if (oldestKey) {
            ...
            this.context.logger.debug("Cache: Evicted LRU entry: ".concat(oldestKey));
        }
    }
    /**
     * Get cache size
    ...
    async loadImage(key) {
        ...
        return await new Promise((resolve, reject)=>{
            ...
            if (this._options.imageTimeout > 0) {
                setTimeout(()=>reject("Timed out (".concat(this._options.imageTimeout, "ms) loading image")), this._options.imageTimeout);
            }
        });
    }
    has(key) {
    ...
    constructor(context, _options){
        ...
        var _options_maxCacheSize;
        // Default cache size: 100 items
        this.maxSize = (_options_maxCacheSize = _options.maxCacheSize) !== null && _options_maxCacheSize !== void 0 ? _options_maxCacheSize : 100;
        if (this.maxSize < 1) {
            throw new Error('Cache maxSize must be at least 1');
        }
        if (this.maxSize > 10000) {
            this.context.logger.warn("Cache maxSize ".concat(this.maxSize, " is very large and may cause memory issues. ") + "Consider using a smaller value (recommended: 100-1000).");
        }
    }
}
 ...
 */ class OriginChecker {
    ...
    constructor(window1){
        if (!window1 || !window1.document) {
            throw new Error('Valid window object required for OriginChecker');
        }
        if (!window1.location || !window1.location.href) {
            throw new Error('Window object must have valid location');
        }
        this.link = window1.document.createElement('a');
        this.origin = this.getOrigin(window1.location.href);
    }
}
class Context {
    constructor(options, windowBounds, config){
        ...
        var _options_cache, _ref;
        this.cache = (_ref = (_options_cache = options.cache) !== null && _options_cache !== void 0 ? _options_cache : config.cache) !== null && _ref !== void 0 ? _ref : new Cache(this, options);
    }
}
 ...
 */ class Html2CanvasConfig {
     ...
     */ clone() {
        ...
        var _options_cspNonce, _options_cache;
        return new Html2CanvasConfig({
            window: options.window || this.window,
            cspNonce: (_options_cspNonce = options.cspNonce) !== null && _options_cspNonce !== void 0 ? _options_cspNonce : this.cspNonce,
            cache: (_options_cache = options.cache) !== null && _options_cache !== void 0 ? _options_cache : this.cache
        });
    }
    constructor(options = {}){
 ...
 */ class Validator {
     ...
     */ validateUrl(url) {
        ...
        try {
            ...
            if (![
                ...
                return {
                    valid: false,
                    error: "Protocol ".concat(parsedUrl.protocol, " is not allowed. Only http and https are permitted.")
                };
            }
            ...
            if (context === 'proxy' && this.config.allowedProxyDomains && this.config.allowedProxyDomains.length > 0) {
                ...
                if (!isAllowed) {
                    return {
                        valid: false,
                        error: "Proxy domain ".concat(parsedUrl.hostname, " is not in the allowed list")
                    };
                }
            }
            ...
            return {
                valid: false,
                error: "Invalid URL format: ".concat(e instanceof Error ? e.message : 'Unknown error')
            };
        }
    }
    /**
     ...
     */ validateImageTimeout(timeout) {
        ...
        if (this.config.maxImageTimeout && timeout > this.config.maxImageTimeout) {
            return {
                valid: false,
                error: "Image timeout ".concat(timeout, "ms exceeds maximum allowed ").concat(this.config.maxImageTimeout, "ms")
            };
        }
        return {
            valid: true,
     ...
     */ validateDimensions(width, height) {
        ...
        if (width > MAX_DIMENSION || height > MAX_DIMENSION) {
            return {
                valid: false,
                error: "Dimensions exceed maximum allowed (".concat(MAX_DIMENSION, "px)")
            };
        }
        return {
            valid: true,
     ...
     */ validateOptions(options) {
        ...
        if (proxyUrl !== undefined && proxyUrl !== null && typeof proxyUrl === 'string' && proxyUrl.length > 0) {
            ...
            if (!proxyResult.valid) {
                errors.push("Proxy: ".concat(proxyResult.error));
            }
        ...
        if (options.imageTimeout !== undefined) {
            ...
            if (!timeoutResult.valid) {
                errors.push("Image timeout: ".concat(timeoutResult.error));
            }
        }
        // Validate dimensions
        if (options.width !== undefined || options.height !== undefined) {
            var _options_width;
            const width = (_options_width = options.width) !== null && _options_width !== void 0 ? _options_width : 800;
            var _options_height;
            const height = (_options_height = options.height) !== null && _options_height !== void 0 ? _options_height : 600;
            const dimensionsResult = this.validateDimensions(width, height);
            if (!dimensionsResult.valid) {
                errors.push("Dimensions: ".concat(dimensionsResult.error));
            }
        }
        // Validate scale
        if (options.scale !== undefined) {
            ...
            if (!scaleResult.valid) {
                errors.push("Scale: ".concat(scaleResult.error));
            }
        }
        // Validate CSP nonce
        if (options.cspNonce !== undefined) {
            ...
            if (!nonceResult.valid) {
                errors.push("CSP nonce: ".concat(nonceResult.error));
            }
        }
        // Custom validation
        if (this.config.customValidator) {
            ...
            if (!customResult.valid) {
                errors.push("Custom validation: ".concat(customResult.error));
            }
        }
        if (errors.length > 0) {
            return {
 ...
 */ class PerformanceMonitor {
     ...
     */ start(name, metadata) {
        ...
        if (this.activeMetrics.has(name)) {
            var _this_context;
            (_this_context = this.context) === null || _this_context === void 0 ? void 0 : _this_context.logger.warn("Performance metric '".concat(name, "' already started. Overwriting."));
        }
     ...
     */ end(name) {
        ...
        if (!metric) {
            var _this_context1;
            (_this_context1 = this.context) === null || _this_context1 === void 0 ? void 0 : _this_context1.logger.warn("Performance metric '".concat(name, "' not found. Was start() called?"));
            return undefined;
        }
        ...
        (_this_context = this.context) === null || _this_context === void 0 ? void 0 : _this_context.logger.debug("⏱️  ".concat(name, ": ").concat(metric.duration.toFixed(2), "ms"), metric.metadata);
        return metric;
    }
    /**
     ...
     */ logSummary() {
        ...
        this.context.logger.info("\n📊 Performance Summary (Total: ".concat(summary.totalDuration.toFixed(2), "ms):"));
        summary.breakdown.sort((a, b)=>b.duration - a.duration).forEach((item)=>{
            this.context.logger.info("  ".concat(item.name.padEnd(20), " ").concat(item.duration.toFixed(2).padStart(8), "ms  ").concat(item.percentage.padStart(6)));
        });
    }
    /**
     * Clear all metrics
 ...
 */ const html2canvas = function(element) {
    let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, config = arguments.length > 2 ? arguments[2] : void 0;
 ...
 */ const setCspNonce = (nonce)=>{
    ...
    if (typeof window !== 'undefined') {
        setDefaultConfig(new Html2CanvasConfig({
            window,
            cspNonce: nonce
        }));
    }
...
const renderElement = async (element, opts, config)=>{
    ...
    if (!opts.skipValidation) {
        ...
        if (!optionsValidation.valid) {
            throw new Error("Invalid options: ".concat(optionsValidation.error));
        }
    }
    ...
    var _opts_allowTaint, _opts_imageTimeout, _opts_useCORS;
    const resourceOptions = {
        allowTaint: (_opts_allowTaint = opts.allowTaint) !== null && _opts_allowTaint !== void 0 ? _opts_allowTaint : false,
        imageTimeout: (_opts_imageTimeout = opts.imageTimeout) !== null && _opts_imageTimeout !== void 0 ? _opts_imageTimeout : 15000,
        proxy: opts.proxy,
        useCORS: (_opts_useCORS = opts.useCORS) !== null && _opts_useCORS !== void 0 ? _opts_useCORS : false,
        customIsSameOrigin: opts.customIsSameOrigin
    };
    var _opts_logging, _opts_cache;
    const contextOptions = {
        logging: (_opts_logging = opts.logging) !== null && _opts_logging !== void 0 ? _opts_logging : true,
        cache: (_opts_cache = opts.cache) !== null && _opts_cache !== void 0 ? _opts_cache : config.cache,
        ...resourceOptions
    };
    ...
    var _opts_windowWidth, _ref, _opts_windowHeight, _ref1, _opts_scrollX, _ref2, _opts_scrollY, _ref3;
    const windowOptions = {
        windowWidth: (_ref = (_opts_windowWidth = opts.windowWidth) !== null && _opts_windowWidth !== void 0 ? _opts_windowWidth : win.innerWidth) !== null && _ref !== void 0 ? _ref : DEFAULT_WINDOW_WIDTH,
        windowHeight: (_ref1 = (_opts_windowHeight = opts.windowHeight) !== null && _opts_windowHeight !== void 0 ? _opts_windowHeight : win.innerHeight) !== null && _ref1 !== void 0 ? _ref1 : DEFAULT_WINDOW_HEIGHT,
        scrollX: (_ref2 = (_opts_scrollX = opts.scrollX) !== null && _opts_scrollX !== void 0 ? _opts_scrollX : win.pageXOffset) !== null && _ref2 !== void 0 ? _ref2 : DEFAULT_SCROLL,
        scrollY: (_ref3 = (_opts_scrollY = opts.scrollY) !== null && _opts_scrollY !== void 0 ? _opts_scrollY : win.pageYOffset) !== null && _ref3 !== void 0 ? _ref3 : DEFAULT_SCROLL
    };
    ...
    var _opts_enablePerformanceMonitoring, _ref4;
    // Initialize performance monitoring if enabled
    const performanceMonitoring = (_ref4 = (_opts_enablePerformanceMonitoring = opts.enablePerformanceMonitoring) !== null && _opts_enablePerformanceMonitoring !== void 0 ? _opts_enablePerformanceMonitoring : opts.logging) !== null && _ref4 !== void 0 ? _ref4 : false;
    ...
    var _opts_foreignObjectRendering;
    const foreignObjectRendering = (_opts_foreignObjectRendering = opts.foreignObjectRendering) !== null && _opts_foreignObjectRendering !== void 0 ? _opts_foreignObjectRendering : false;
    var _opts_allowTaint1, _opts_cspNonce;
    const cloneOptions = {
        allowTaint: (_opts_allowTaint1 = opts.allowTaint) !== null && _opts_allowTaint1 !== void 0 ? _opts_allowTaint1 : false,
        onclone: opts.onclone,
        ignoreElements: opts.ignoreElements,
        iframeContainer: opts.iframeContainer,
        inlineImages: foreignObjectRendering,
        copyStyles: foreignObjectRendering,
        cspNonce: (_opts_cspNonce = opts.cspNonce) !== null && _opts_cspNonce !== void 0 ? _opts_cspNonce : config.cspNonce
    };
    ...
    var _opts_scale, _ref5, _opts_x, _opts_y, _opts_width, _opts_height;
    const renderOptions = {
        canvas: opts.canvas,
        backgroundColor,
        scale: (_ref5 = (_opts_scale = opts.scale) !== null && _opts_scale !== void 0 ? _opts_scale : defaultView.devicePixelRatio) !== null && _ref5 !== void 0 ? _ref5 : 1,
        x: ((_opts_x = opts.x) !== null && _opts_x !== void 0 ? _opts_x : 0) + left,
        y: ((_opts_y = opts.y) !== null && _opts_y !== void 0 ? _opts_y : 0) + top,
        width: (_opts_width = opts.width) !== null && _opts_width !== void 0 ? _opts_width : Math.ceil(width),
        height: (_opts_height = opts.height) !== null && _opts_height !== void 0 ? _opts_height : Math.ceil(height),
    ...
    try {
        ...
        var _opts_removeContainer;
        if ((_opts_removeContainer = opts.removeContainer) !== null && _opts_removeContainer !== void 0 ? _opts_removeContainer : true) {
...
//# sourceMappingURL=node_modules_951e7875._.js.map