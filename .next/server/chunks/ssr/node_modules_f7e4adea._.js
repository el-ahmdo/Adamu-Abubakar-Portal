        ...
        case 4 /* CLIP_PATH_TYPE.POLYGON */ :
            {
                ...
                const absPoints = clipPath.points.map(([px, py])=>[
            ...
            switch(paintOrderLayer){
                ...
                case 1 /* PAINT_ORDER_LAYER.STROKE */ :
                    if (styles.webkitTextStrokeWidth && textBound.text.trim().length) {
                        ...
                        this.ctx.lineJoin = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 'round';
 ...
 */ class Html2CanvasConfig {
    constructor(options = {}){
        ...
        this.window = options.window || (("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : null);
        if (!this.window) {
...
//# sourceMappingURL=node_modules_f7e4adea._.js.map